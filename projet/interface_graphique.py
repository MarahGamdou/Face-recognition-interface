            ...
            for (x,y,w,h) in faces:
                ...
                if len(frontal_eyes) > 0:
                    ...
                    if len(small_eyes) > 0:
                        ...
                        if  ey<sy and eh>sh:
                            # cv2.rectangle(img,(x+sx,y+sy),(x+sx+sw,y+sy+sh),(255,0,255),2)
...
# label_welcome=Label(main,text='***Bienvenue***',bg='pink',bd=30,height=2)
main['bg'] = 'white'
# label_welcome.pack()
...
bouton3 = Button(main, text="Couvres-chef",width=12,height=2,command=new_window_couvres_chef).pack()
